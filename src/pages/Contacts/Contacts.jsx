    ...
    <div className="ContactsWrapper">
      ...
      <div className="content">
        ...
        <Stack direction="row" spacing={2} className="links">
          ...
          <Button onClick={handleButtonClick} type="submit" variant="contained">
            {t("booking.title")}
          </Button>
        </Stack>
        ...
        {isLoggedIn ? (
          ...
          <div className="cotainer-ratings-info">
            ...
            >
              <Alert severity="info">
                {t("contact.shareOpinion")}{" "}
                <Link className="warning-login" href="/auth" underline="none">
        ...
        <div id="submit-rating-wrapp" className="submit-rating-wrapp">
          <SubmitRating />
        </div>
      </div>
    </div>
