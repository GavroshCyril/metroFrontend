export let enLang = {
  ...
  search: {
    ...
    description03:
      "The most difficult section from the Belarusian State Circus to the Victory Square was climbed in an open way. An impressive scientific and technical solution was the driving of distillation tunnels under the Svisloch River. For it, a simulation-based technology was developed. The simulation of the Svisloch river bed with a protective dam and the face under it on a scale of 1:40, carried out at the Belarusian Polytechnic Institute, showed that tunneling is possible when sandy deposits are drained and without their artificial fixation. Initially, it was planned to freeze the above-tunnel zone, which would require significant material investments and delay the start of tunneling for at least a year.",
    description04:
      "Instead, an artificial channel was laid along the bottom of the river on an area of 1,500 square meters, where 10 steel pipes with a diameter of 1.2 meters were laid, limited on both sides by temporary dams made of diaphragms. A temporary mobile bridge was built over the river in order to then drill wells to freeze the soil and install deep water drawdown installations for the duration of tunnel work. When storming the river, builders sometimes had to work knee-deep in water. On the way there were large boulders and wooden piles of the old bridge, on which, moreover, the bases of reinforced concrete supports were tightly sealed. It was possible to cope with such obstacles only with the help of explosives. Despite all this, the work was completed at a fast pace - the most difficult section of the distillation tunnels was built in less than a year, and the Svisloch itself was completed in just 26 working days.",
    infoTitle:
  ...
  contact: {
    ...
    shareOpinion: "To share your opinion about the visited object,",
  },
  ...
  resources: {
    ...
    shareOffer: "To share a suggestion or comment",
    enterPersAcc: "enter your personal account",
  },
  timer: {
    title: "Until the opening of new metro stations:",
    days: "Days",
    hours: "Hours",
    minutes: "Minutes",
    seconds: "Seconds",
  ...
  register: {
    ...
    logINPersAcc: "Login to your personal account",
  },
  error: {
    title: "Whoops..! It seems the page was not found.",
    desc: "You went to the wrong page on our server :(",
    comeBack: "Come back",
  },

  booking: {
    title: "To sign up for an exhibition viewing",
    fio: "Last name, first name",
    nomerTel: "Phone number",
    primeczanie: "Note",
    sendLetter: "Send",
    sendingLetter: "Sending...",
    callMe: "Please call me back, I want to clarify a couple of points!",
    typeFio: "Enter your last name, first name",
    typeNomerTel: "Enter the phone number",
    elPozcta: "Recipient's email address",
    bookSuccess: "The data has been successfully sent",
  },

  ratingTitle: "Already visited the museum?",
  ratingDesc: "Share your opinion!",
  delete: "Delete entry",
  comment: "Comment",
  offerLabel: "Enter a suggestion or comment",
  send: "Send",
  ...
  bel: "BEL",
  logout: "EXIT",
  appreciated: "We've already been rated!",
  confirmDelete: "Confirm deletion",
  areYouSure: "Are you sure you want to delete the entry?",
  delete: "Delete",
  sendRecord: "Entry sent successfully!",
