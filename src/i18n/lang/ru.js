export const ruLang = {
  nav: {
    home: "Главная",
    projects: "Проекты минского метро (1969-1977)",
    stage: "Первая очередь (1977-1984)",
    map: "Схема минского метрополитена",
    kompozition: "Выставочная экспозиция",
    panel: "Панель администратора",
    info: "История минского метрополитена",
    news: "Новости",
  },
  slider: {},
  home: {
  ...
  contact: {
    ...
    shareOpinion: "Чтобы поделиться своим мнением о посещенном объекте,",
  },
  ...
  admin: {
    ...
    subTitle: "чтобы получить доступ к своему личному кабинету",
    login: "Логин",
    password: "Пароль",
    logIn: "Войти",
    info: " Перед началом администрирования веб-приложением, ознакомьтесь с руководством администратора, кликнув на",
    link: "«Руководство администратора»",
    changeImg: "Изменить изображение",
    loadImg: "Загрузите изображение",
  ...
  register: {
    ...
    logINPersAcc: "Войти в личный кабинет",
  },
  resources: {
    info: "Если вам необходима документация веб-приложения, Вы можете скачать ее при нажатии на",
    link: "«Руководство пользователя»",
    history: "История минского метрополитена",
    map: "Посмотреть карту метрополитена",
    schema: "Скачать схему строения метрополитена до 2050 года",
    portalMinObr:
      "Интернет-портал министерства образования Республики Беларусь",
    portalRepBel: "Национальный правовой интернет-портал Республики Беларусь",
    prezidenta: "Интернет-портал Президента Республики Беларусь",
    minskMetro: "Интернет-портал минского метрополитена",
    minskMetroStroy: "Интернет-портал унитарного предприятия 'МИНСКМЕТРОСТРОЙ'",
    usefullLinks: "Полезные ссылки:",
    desc01:
      " Минский метрополитен был открыт 29 июня 1984 года. Летопись метро начиналась с 8 станций первой линии и электродепо «Московское». Затем появилась вторая ветка и электродепо «Могилевское». Эксплуатационная длина пути минского метро составляет 40,8 километра в двухпутном исчислении. Всего длина путей в однопутном исчислении (с тупиками и путевым развитием депо) составляет около 116 километров.",
    desc02:
      "В состав государственного предприятия «Минский метрополитен» входит 30 структурных подразделений: 10 служб, 2 электродепо, 11 отделов, аппарат главного ревизора по безопасности движения поездов, ситуационный центр, лаборатория метрологии, 4 сектора, 2 общежития. Штатная численность работников метрополитена – более 5 тысяч человек. В период с момента пуска по настоящее время метро белорусской столицы прошло большой путь развития. Государственное предприятие «Минский метрополитен» динамично и эффективно движется вперед в сфере модернизации производственных процессов, делается все необходимое для удобства и комфорта пассажиров.",
    desc03:
      "Метрополитен поступательно обновляет подвижной состав на более современный, комфортный и безопасный. Создана и совершенствуется  доступная среда для удобства пассажиров различных возможностей. На    всех станциях введен бесконтактный способ оплаты проезда с использованием банковских платежных систем. В метро появился доступ в интернет по технологии Wi-Fi.",
    offer: "Предложения и замечания",
    shareOffer: "Чтобы поделиться предложением или замечанием",
    enterPersAcc: "войдите в личный кабинет",
  },
  timer: {
    title: "До открытия новых станций метро:",
    days: "Дней",
    hours: "Часов",
    minutes: "Минут",
    seconds: "Секунд",
  ...
  error: {
    title: "Уууупс..! Кажется страница не найдена.",
    desc: "Вы зашли не на ту страницу на нашем сервере :(",
    comeBack: "Вернуться назад",
  },
  booking: {
    title: "Записаться на просмотр выставочной экспозиции",
    fio: "Фамилия, имя, отчество",
    nomerTel: "Номер телефона",
    primeczanie: "Примечание",
    sendLetter: "Отправить",
    sendingLetter: "Отправление...",
    callMe: "Перезвоните мне, пожалуйста, я хочу уточнить пару моментов!",
    typeFio: "Введите фамилию, имя, отчество",
    typeNomerTel: "Введите номер телефона",
    elPozcta: "Электронная почта получателя",
    bookSuccess: "Данные успешно отправлены",
  },

  ratingTitle: "Уже посещали музей?",
  ratingDesc: "Поделитесь мнением!",
  delete: "Удалить запись",
  comment: "Комментарий",
  offerLabel: "Введите предложение или замечание",
  send: "Отправить",
  ...
  sendRecord: "Запись успешно отправлена!",
  close: "Закрыть",
  appreciated: "Нас уже оценили!",
  next: "Следующий слайд",
  back: "Предыдущий слайд",
};
