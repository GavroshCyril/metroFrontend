export const belLang = {
  nav: {
    ...
    info: "Гісторыя мінскага метрапалітэна",
    news: "Навіны",
  },
  home: {
  ...
  search: {
    ...
    description03:
      "Самы складаны ўчастак ад Белдзяржцырка да плошчы Перамогі праходзіў адкрытым спосабам. Эфектным навукова-тэхнічным рашэннем стала пракладка перагонных тунэляў пад ракой Свіслач. Для гэтага была распрацавана тэхналогія на аснове мадэлявання. Праведзенае ў Беларускім палітэхнічным інстытуце мадэляванне рэчышча ракі Свіслач з ахоўнай дамбай і забоем пад ёй у маштабе 1:40 паказала, што праходка тунэляў магчымая пры асушэнні пясчаных адкладаў і без іх штучнага замацавання. Першапачаткова планавалася замарозіць надтунэльную зону, што запатрабуе значных матэрыяльных укладанняў і адтэрмінуе пачатак пракладкі тунэля мінімум на год.",
    description04:
      "Замест гэтага па дне ракі абклалі штучнае рэчышча на плошчы 1500 квадратных метраў, дзе праклалі 10 стальных труб дыяметрам 1,2 метра, абмежаваных з двух бакоў часовымі плацінамі з дыяфрагмаў. Над ракой збудавалі часовы перасоўны мост, каб затым вырабляць бурэнне свідравін для замарожвання грунта і мантажу ўсталёвак глыбіннага водапаніжэння на час тунэльных прац. Пры штурме ракі будаўнікам часам даводзілася працаваць па калена ў вадзе. На шляху сустракаліся буйныя валуны і драўляныя палі старога моста, на якіх да таго ж намёртва заладжаны падставы жалезабетонных апор. Справіцца з такімі перашкодамі можна было толькі пры дапамозе ўзрыўчаткі. Нягледзячы на ўсё гэта, працы былі завершаны хуткімі тэмпамі - самы цяжкі ўчастак перагонных тунэляў быў збудаваны менш чым за год, а сама Свіслач была пройдзена ўсяго за 26 працоўных дзён.",
    infoTitle:
  ...
  contact: {
    ...
    shareOpinion: "Каб падзяліцца сваім меркаваннем аб наведаным аб'екце,",
  },
  ...
  resources: {
    info: "Калі вам неабходна дакументацыя вэб-прыкладанні, Вы можаце спампаваць яе пры націску на",
    link: "«Кіраўніцтва карыстальніка»",
    history: "Гісторыя мінскага метрапалітэна",
    map: "Паглядзець карту метрапалітэна",
    schema: "Запампаваць схему будынка метрапалітэна да 2050 года",
    portalMinObr: "Інтэрнэт-партал міністэрства адукацыі Рэспублікі Беларусь",
    portalRepBel: "Нацыянальны прававы інтэрнэт-партал Рэспублікі Беларусь",
    prezidenta: "Інтэрнет-партал Прэзідэнта Рэспублікі Беларусь",
    minskMetro: "Інтэрнет-партал мінскага метрапалітэна",
    minskMetroStroy: "Інтэрнет-партал унітарнага прадпрыемства 'МІНСКМЕТРАБУД'",
    usefullLinks: "Карысныя спасылкі:",
    desc01:
      "Менскі метрапалітэн быў адкрыты 29 чэрвеня 1984 года. Летапіс метро пачынаўся з 8 станцый першай лініі і электрадэпо 'Маскоўскае'. Затым з'явілася другая галіна і электрадэпо 'Магілёўскае'. Эксплуатацыйная даўжыня пуці мінскага метро складае 40,8 кіламетра ў двухшляховым вылічэнні. Усяго даўжыня шляхоў у аднашляховым вылічэнні (з тупікамі і шляхавым развіццём дэпо) складае каля 116 кіламетраў.",
    desc02:
      "У склад дзяржаўнага прадпрыемства 'Мінскі метрапалітэн' уваходзіць 30 структурных падраздзяленняў: 10 службаў, 2 электрадэпо, 11 аддзелаў, апарат галоўнага рэвізора па бяспецы руху цягнікоў, сітуацыйны цэнтр, лабараторыя метралогіі, 4 сектары, 2 інтэрнаты. Штатная колькасць работнікаў метрапалітэна - больш за 5 тысяч чалавек. У перыяд з моманту пуску да гэтага часу метро беларускай сталіцы прайшло вялікі шлях развіцця. Дзяржаўнае прадпрыемства 'Мінскі метрапалітэн' дынамічна і эфектыўна рухаецца наперад у сферы мадэрнізацыі вытворчых працэсаў, робіцца ўсё неабходнае для зручнасці і камфорту пасажыраў.",
    desc03:
      "Метрапалітэн паступальна абнаўляе рухомы састаў на больш сучасны, камфортны і бяспечны. Створана і ўдасканальваецца даступнае асяроддзе для зручнасці пасажыраў розных магчымасцей. На ўсіх станцыях уведзены бескантактны спосаб аплаты праезду з выкарыстаннем банкаўскіх плацежных сістэм. У метро з'явіўся доступ у інтэрнет па тэхналогіі Wi-Fi.",
    offer: "Прапановы і заўвагі",
    shareOffer: "Каб падзяліцца прапановай ці заўвагай",
    enterPersAcc: "увайдзіце ў асабісты кабінет",
  },
  timer: {
    title: "Да адкрыцця новых станцый метро:",
    days: "Дзён",
    hours: "Гадзін",
    minutes: "Хвілін",
    seconds: "Секунд",
  ...
  admin: {
    panel: "Панэль адміністратара",
    title: "Аўтарызуйцеся",
    subTitle: "каб атрымаць доступ да свайго асабістага кабінета",
    login: "Лагін",
    password: "Пароль",
    logIn: "Увайсці",
    info: " Перад пачаткам адміністравання вэб-дадаткам, азнаёмцеся з кіраўніцтвам адміністратара, клікнуўшы на",
    link: "«Кіраўніцтва адміністратара»",
    changeImg: "Змяніць малюнак",
    loadImg: "Загрузіце малюнак",
    noAccount: "Няма акаўнта?",
  },
  register: {
    title: "Зарэгіструйцеся",
    subTitle: "каб атрымаць доступ да свайго асабістага кабінета",
    logIn: "Зарэгістравацца",
    repeatPass: "Пацвердзіце пароль",
    haveAccount: "Ужо ёсць акаўнт?",
    logINPersAcc: "Увайсці ў асабісты кабінет",
  },
  error: {
    title: "Уууупс..! Здаецца старонка не знойдзена.",
    desc: "Вы зайшлі не на тую старонку на нашым сэрвэры :(",
    comeBack: "Вярнуцца назад",
  },
  booking: {
    title: "Запісацца на прагляд выставачнай экспазіцыі",
    fio: "Прозвішча, імя, па бацьку",
    nomerTel: "Нумар тэлефона",
    primeczanie: "Заўвага",
    sendLetter: "Адправіць",
    sendingLetter: "Адпраўленне...",
    callMe: "Перазваніце мне, калі ласка, я хачу ўточніць некалькі момантаў!",
    typeFio: "Увядзіце прозвішча, імя, па бацькe",
    typeNomerTel: "Увядзіце нумар тэлефона",
    elPozcta: "Адрас электроннай пошты атрымальніка",
    bookSuccess: "Дадзеныя паспяхова дасланы",
  },

  ratingTitle: "Ужо наведвалі музей?",
  ratingDesc: "Падзяліцеся меркаваннем!",
  delete: "Выдаліць запіс",
  comment: "Каментар",
  offerLabel: "Увядзіце прапанову або заўвагу",
  send: "Адправіць",

  printMaterial: "Версія для друку",
  downloadMaterial: "Спампаваць матэрыял",
  login: "Увайсці",
  more: "Падрабязней",
  save: "Захаваць",
  cancel: "Адмяніць",
  ...
  bel: "БЕЛ",
  logout: "ВЫХАД",
  appreciated: "Нас ужо ацанілі!",
  confirmDelete: "Пацвердзіце выдаленне",
  areYouSure: "Вы ўпэўненыя, што жадаеце выдаліць запіс?",
  delete: "Выдаліць",
  sendRecord: "Запіс паспяхова дасланы!",
  successDelete: "Запіс паспяхова выдалена!",
  next: "Наступны слайд",
  back: "Папярэдні слайд",
};
